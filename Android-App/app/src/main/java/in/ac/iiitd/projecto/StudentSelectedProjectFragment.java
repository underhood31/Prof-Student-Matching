...
public class StudentSelectedProjectFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_student_selected_project, container, false);
        this.recyclerView = view.findViewById(R.id.shortlistedProjectRecyclerView);
